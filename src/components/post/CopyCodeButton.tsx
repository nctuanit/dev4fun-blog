...
export default function CopyCodeButton() {
    useEffect(() => {
        ...
        codeBlocks.forEach((pre) => {
            ...
            button.className = 'copy-code-btn absolute top-2 right-2 p-2 rounded-lg bg-secondary/80 hover:bg-secondary text-muted-foreground hover:text-foreground opacity-0 group-hover:opacity-100 transition-all duration-200 z-10';
